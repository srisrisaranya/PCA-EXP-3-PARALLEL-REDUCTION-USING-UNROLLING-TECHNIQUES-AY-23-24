...
__global__ void reduceUnrolling8(int *g_idata, int *g_odata, unsigned int n)
{
    ...
    if (idx + 7 * blockDim.x < n) {
        ...
        g_idata[blockIdx.x] = a1 + a2 + a3 + a4 + b1 + b2 + b3 + b4;
    }
...
__global__ void reduceUnrolling16(int *g_idata, int *g_odata, unsigned int n)
{
    ...
    if (idx + 15 * blockDim.x < n) {
        ...
        g_idata[blockIdx.x] = a1 + a2 + a3 + a4 + a5 + a6 + a7 + a8 +
...
## OUTPUT:
<img width="841" height="158" alt="image" src="https://github.com/user-attachments/assets/aa8edff2-ef13-48de-9b25-96ce67f0b313" />
